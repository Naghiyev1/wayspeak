...
function containsJapanese(t){return /[\u3040-\u30ff]/.test(t||"")}function containsKorean(t){return /[\uac00-\ud7af]/.test(t||"")}
...
function phrasebookTranslate(text){
  ...
  const region=(targetLang.value==="ja"||sourceLang.value==="ja")?"japan":(targetLang.value==="ko"||sourceLang.value==="ko")?"korea":"china";
  ...
  if(targetLang.value==="zh"||targetLang.value==="ja"||targetLang.value==="ko")return p.translated;
  return p.text;
}
...
function loadPhrase(p){inputText.value=p.text;outputText.textContent=p.translated;sourceLang.value="en";targetLang.value=p.region==="japan"?"ja":p.region==="korea"?"ko":"zh";updateRomanization();saveLang();saveRecent(inputText.value,outputText.textContent)}
